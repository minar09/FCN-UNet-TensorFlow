...
def read_dataset(data_dir):
    if False:
        ...
        testdir = "E:/Dataset/Dataset10k/images/training/"  # os.path.join(data_dir, '/ADEChallengeData2016/images/training/')
        ...
        validationdir = "E:/Dataset/Dataset10k/images/validation/"  #os.path.join(data_dir, '/ADEChallengeData2016/images/validation/')
